                ...
                <div className='container'>
                    <div className='sidebar__container'>
                        <div className='sidebar__links'>
                            <NavLink to='/' className="sidebar__link" activeClassName="active">
                                <span className='sidebar__link--text'>Coupons</span>
                            </NavLink>
                            <NavLink to='/vendors' className="sidebar__link" activeClassName="active">
                                <span className='sidebar__link--text'>Vendors</span>
                            </NavLink>
                            <NavLink to='/category' className="sidebar__link" activeClassName="active">
                                <span className='sidebar__link--text'>Category</span>
                            </NavLink>
                            <NavLink to='/users' className="sidebar__link" activeClassName="active">
                                <span className='sidebar__link--text'>Users</span>
                            </NavLink>
                            <NavLink to='/profile' className="sidebar__link" activeClassName="active">
